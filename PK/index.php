...
<a href="#" class="scrollup"><i class="fa fa-angle-up active"></i></a>
    ...
    <script src="https://maps.google.com/maps/api/js?key=AIzaSyBz8KwBpRRnmP_JBv7IA06wURBbA4WYVMc""></script>
        <!-- Custom Google Map -->
            ...
            function init() {
                ...
                for (var s in styles) {
                  var opt = {
                    ...
                    scrollwheel: false,
                    center: new google.maps.LatLng(46.739162, 8.199588),
                    zoom: 10,
                    mapTypeId: s
                  };
                  ...
                  var goldStar = 'assets/img/marker.png';
